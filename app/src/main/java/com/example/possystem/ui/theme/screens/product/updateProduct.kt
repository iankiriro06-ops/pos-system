...
fun UpdateProductScreen(navController: NavController,productId:String) {
    ...
    var barcode_number by remember { mutableStateOf(product!!.barcode_number ?: "") }
    var date_of_manufacture by remember { mutableStateOf(product!!.date_of_manufacture ?: "") }
        ...
        Card(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Quantity") },
                    placeholder = { Text("quantity of the product") },
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { date_of_manufacture = it },
                    label = { Text("date of manufacture") },
                    placeholder = { Text("date of manufacture") },
                    modifier = fieldModifier.height(120.dp),
                    shape = fieldShape,
                    maxLines = 5
                )
